<template>
  <div class="max-w-4xl mx-auto space-y-8 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="space-y-4">
      ...
      <h1 class="text-4xl font-bold tracking-tighter">AP PHP</h1>
    ...
    <div class="space-y-4">
      ...
      <div class="text-muted-foreground">
        <p>AP PHP est un site web dynamique développé en PHP, utilisant une base de données pour gérer et afficher des informations en temps réel. Il permet aux utilisateurs d'interagir avec le contenu, facilitant des opérations comme l'enregistrement et la modification de données, ce qui en fait un choix idéal pour des applications web telles que des blogs ou des forums.</p>
        <p class="mt-4">Ce projet a été développé en utilisant la méthode Agile, permettant une adaptation rapide aux changements et une livraison continue de fonctionnalités.</p>
      </div>
    </div>
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div class="rounded-lg border p-4">
          <div class="flex items-center space-x-2">
            ...
            <h3 class="font-semibold">CRUD Complet</h3>
          </div>
          <p class="mt-2 text-sm text-muted-foreground">
    ...
    <div class="space-y-4">
      ...
      <div class="rounded-lg border p-6">
        <div class="flex flex-col items-center space-y-4">
          ...
          <a href="https://example.com/ap-php" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90">
            Voir la Démo
